...
class NightOcc_FlashOcc_forward_backward_v2_illubev(BEVDet):
    def __init__(self,
                # 光照增强模块
                 light_enhance=dict(
                 ...
                 upsample=False,
                 **kwargs):
        super(NightOcc_FlashOcc_forward_backward_v2_illubev, self).__init__(**kwargs)
        ##################################################################
...
@DETECTORS.register_module()
class NightOcc_FlashOcc_forward_backward_v2_illubev_stereo(BEVStereo4D):
    def __init__(self,
                 #####################################################
                 # 光照增强模块
                 light_enhance=dict(
                 ...
                 upsample=False,
                 **kwargs):
        super(NightOcc_FlashOcc_forward_backward_v2_illubev_stereo, self).__init__(**kwargs)
        ##############################################################################
        self.light_enhance = build_neck(light_enhance)
        if light_enhance_weights_path:
            light_enhance_weights = torch.load(light_enhance_weights_path)
